...
<body>
	...
	<form:form id="inputForm" modelAttribute="platUser" action="${ctx}/plat/platUser/update/changeTag" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">当前解锁时间：</label>
			<div class="controls">
				<span class="help-inline">
					<font color="red"> <fmt:formatDate value="${platUser.lockDate}" pattern="yyyy-MM-dd HH:mm:ss"/> </font>
				</span>
			</div>
		</div>

		<%--<c:if test="${platUser.isLockTrade == '0'}">--%>
			<div class="control-group">
				<label class="control-label">解锁时间：</label>
				<div class="controls">
					<input name="lockDate" type="text" readonly="readonly" maxlength="45" class="input-medium Wdate required"
						   value=""
