...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/plat/jsPlatUserCoinVolumeHistory/">手动转账列表</a></li>
		<shiro:hasPermission name="plat:jsPlatUserCoinVolumeHistory:edit"><li><a href="${ctx}/plat/jsPlatUserCoinVolumeHistory/form">手动转账添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="jsPlatUserCoinVolumeHistory" action="${ctx}/plat/jsPlatUserCoinVolumeHistory/" method="post" class="breadcrumb form-search">
