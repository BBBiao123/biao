...
debugger;
						...
						$.ajax({
							type: "POST",
							async: false,
							url: "${ctx}/sys/user/updatePlatUser",
							data: {id:sysId,relPlatUserId:userId},// 要提交的表单
...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属公司</th><th>归属部门</th><th class="sort-column login_name">登录名</th><th class="sort-column name">姓名</th><th>电话</th><th>手机</th><th>关联用户ID</th><%--<th>角色</th> --%><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<td>${user.phone}</td>
				<td>${user.mobile}</td>
				<td><a href="${ctx}/sys/user/formPlatUser?id=${user.relPlatUserId}">
						${user.relPlatUserId}
					</a></td><%--
				...
				<shiro:hasPermission name="sys:user:edit"><td>
					...
					<a href="#" id="relUser" onclick="upadteRelUser('${user.id}')">设置关联用户</a>
