...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/market/mkCommonPlatIncomeLog/">平台收入流水列表</a></li>
		<li class="active"><a href="${ctx}/market/mkCommonPlatIncomeLog/form?id=${mkCommonPlatIncomeLog.id}">平台收入流水<shiro:hasPermission name="market:mkCommonPlatIncomeLog:edit">${not empty mkCommonPlatIncomeLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="market:mkCommonPlatIncomeLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mkCommonPlatIncomeLog" action="${ctx}/market/mkCommonPlatIncomeLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="beginDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${mkCommonPlatIncomeLog.beginDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${mkCommonPlatIncomeLog.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">成功或失败原因：</label>
			<div class="controls">
				<form:input path="remark" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="market:mkCommonPlatIncomeLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
