 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/market/mkAutoTradeMonitor")
public class MkAutoTradeMonitorController extends BaseController {
	...
	@RequiresPermissions("market:mkAutoTradeMonitor:view")
	...
	public String list(MkAutoTradeMonitor mkAutoTradeMonitor, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		mkAutoTradeMonitor.setBusType("1");
		...
		return "modules/market/mkAutoTradeMonitorList";
	}
	...
	@RequiresPermissions("market:mkAutoTradeMonitor:edit")
	...
	@RequiresPermissions("market:mkAutoTradeMonitor:end")
	@RequestMapping(value = "end")
	public String end(MkAutoTradeMonitor mkAutoTradeMonitor, RedirectAttributes redirectAttributes) {
		mkAutoTradeMonitor.setStatus("4");
		mkAutoTradeMonitor.setRemark("手动中断结束！");
		mkAutoTradeMonitor.setOrderEndDate(new Date());
		mkAutoTradeMonitorService.save(mkAutoTradeMonitor);
		addMessage(redirectAttributes, "中断成功");
		return "redirect:"+Global.getAdminPath()+"/market/mkAutoTradeMonitor/?repage";
	}
