 ...
 * @version 2018-08-09
 */
public class MkCommonPlatIncomeLog extends DataEntity<MkCommonPlatIncomeLog> {
	...
	public MkCommonPlatIncomeLog() {
		super();
	}

	public MkCommonPlatIncomeLog(String id){
		super(id);
	}
	...
	@Length(min=0, max=500, message="成功或失败原因长度必须介于 0 和 500 之间")
