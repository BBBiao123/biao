...
public class SmsMessageTest {
     ...
     *
     *
     * @Value("${access.keyId.conf}") private String accessKeyIdConf = accessKeyId ;
     *
     * @Value("${access.keySecret.conf}") private String accessKeySecretConf =
     * accessKeySecret ;
     *
     * @Value("${access.signName}") private String signNameConf = signName ;
     */
