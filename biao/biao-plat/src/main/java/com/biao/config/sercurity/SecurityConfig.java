    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .authorizeExchange().pathMatchers(
                        ...
                        "/biao/trade/batchCancelTradeAbc","/biao/balance/**","/biao/user/login","/biao/user/vaildCode/numRandom","/biao/user/app/lastVersion","/biao/user/usdt/exchangeRate","/biao/user/sysdict/countryCode")
                .permitAll().and()
