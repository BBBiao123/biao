...
public interface CustomerServerAccessDeniedHandler extends ServerAccessDeniedHandler {
    ...
    default Mono<Void> verify(Mono<Authentication> authentication, ServerWebExchange object) {
        return check(authentication, object)
                ...
                .switchIfEmpty(Mono.defer(() -> Mono.error(new CustomerAuthException(Constants.USER_TICKETOUT_CODE))))
