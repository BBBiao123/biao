...
public class Constants {
     ...
     * 设置一下buyUrl；
     */
    public static final String BUY_URL = "biao/trade/buyIn";
    /**
     * sell url key;
     */
    public static final String SELL_URL = "biao/trade/sellOut";
    /**
     * 获取订单号的接口；
     */
    public static final String ORDER_NO_URL = "biao/trade/getOrderNo";
    /**
     * 登录的接口信息；
     */
    public static final String LOGIN = "biao/user/login";
    /**
     * 主区key
     */
    ...
    public static final String PASSWORD = "P8XEZh4dLwWWq6i4UzNQiVmLvwgZf8C+igIUzvF4ROWS1yfKmhMAx431yTCBFVCakVEXttJUsmdN0DJ/hrKLTZeCQ0MXxjOruPyV5EWimKG4EBwQQSsP1RTv7NBIk0LR/y8dUgRlz7kJ59gcHY1TmZOoZx55hFGcXwImMsL5ifM=";
    /**
     * 数据分隔点信息；
     */
