...
public class AliyunOOSUtils {
    ...
    public static void main(String[] args) throws IOException {
        ...
        clientConfig.setBucketName(getBucketName("2019RE","image"));
    	...
    	File file = new File("e://banner1.jpg");
    	System.out.println(readImage(new FileInputStream(file),file.getName(),file.length()));
        //System.out.println(map.get("imageData"));
    }

    public static String readImage(FileInputStream inputStream,String fileName,Long fileSzie) throws FileNotFoundException {
        ...
        String idcardBucketName = AliyunOOSUtils.getBucketName("re", imageName);
        ...
        clientConfig.setEndpoint("oss-cn-shenzhen.aliyuncs.com");
        AliyunOOSUtils.uploadToAliyun(clientConfig, inputStream, idcardBucketName, AliyunOOSUtils.createObjectMetadata("application/" + contentType, fileSzie, "utf-8", userMetadata));
