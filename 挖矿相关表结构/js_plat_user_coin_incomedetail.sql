...
CREATE TABLE `js_plat_user_coin_incomedetail` (
  ...
  `detail_income` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '收益',
  ...
  `statics_income` decimal(32,16) DEFAULT '0.0000000000000000',
  `team_record` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '团队业绩',
  `team_community_record` decimal(32,16) DEFAULT '0.0000000000000000',
  `team_level` int(4) DEFAULT NULL COMMENT '等级',
  `community_statics_income` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '社区静态收益',
  `node_number` int(10) DEFAULT NULL COMMENT '直推节点个数',
  `reality_statics_income` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '实际静态收益',
  ...
  `dynamics_income` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '动态收益',
  `refer_id` varchar(64) DEFAULT NULL COMMENT '上级ID',
  `sum_revenue` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '总收益',
  `valid_num` bigint(32) DEFAULT NULL,
  `community_sum_manage_reward` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '总的社区管理奖',
  `team_coin_record` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '社区总额-最大值',
  `level_difference_reward` decimal(32,16) DEFAULT NULL COMMENT '级差奖',
  `one_level_income` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '一级邀请静态收益',
  PRIMARY KEY (`id`)
