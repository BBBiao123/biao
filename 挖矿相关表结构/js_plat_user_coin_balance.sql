...
CREATE TABLE `js_plat_user_coin_balance` (
  ...
  `coin_balance` decimal(32,16) DEFAULT '0.0000000000000000' COMMENT '余额',
  ...
  `deposit_value` decimal(31,16) DEFAULT '0.0000000000000000' COMMENT '存入市值',
  PRIMARY KEY (`id`)
